...
Photochemical oxidation of Carbon Monoxide (CO), methane (CH$_4$), and other Volatile Organic Chemicals (VOCs) while nitrous oxides (NOx $\equiv$ NO $+$ NO$_2$) are present, is the main source of tropospheric ozone.
Downward stratospheric transport is the next largest sources \cite{Stevenson_2006}.
...
Photolysis of NO$_2$ forms NO + O(1D), which combines with O$_2$ to form O$_3$, leading to reaction with NO to form NO$_2$ + O$_2$.
