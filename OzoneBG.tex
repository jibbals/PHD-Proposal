...
Photochemical oxidation of Carbon Monoxide (CO), methane (CH$_4$), and other Volatile Organic Chemicals (VOCs) while nitrous oxides (NOx $\equiv$ NO $+$ NO$_2$) are present, is the main source of tropospheric ozone \cite{Stevenson_2006}.
...
The amounts of ozone from STTs and photochemical production are estimated to be around 550 and 5100 Tg yr$^{-1}$, respectively \cite{Stevenson_2006}. 
...
These reactions reach an equilibrium where O$_3$ is proportional to the ratio between NO$_2$ and NO.
...
One dominant precursor to ozone is isoprene (C5H8), which in the atmosphere reacts rapidly with hydroxyl radicals (OH) to form peroxy radicals (O$_2$).
These react with nitrogen oxides and can lead to ground-level ozone formation similarly to the CO reaction listed prior.

Formaldehyde (HCHO) and NO$_2$ regulate tropospheric oxidation capacity through O$_3$ production, as well as being health hazards.
...
In Australia VOCs and NOx are largely emitted from biogenic sources, although some anthropogenic influence is seen from biomass burning in the Northern Territory \cite{Guenther_2006, VanDerA_2008}.
