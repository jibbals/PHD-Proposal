...
Beers law states that $ T = I/I_0 = e^{-\tau} $ with T being transmittance, \tau being optical depth, and I, I$_0$ being radiation intensity at instrument and source respectively.
Using 
$ \tau_i = \int \rho_i \beta_i ds $ gives us:
$$ I = I_0 e^{ \left( \Sigma_i \int \rho_i \beta_i ds \right) } $$
