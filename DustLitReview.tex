...
Oceanic carbon cycling is a complex system in which iron is often a limiting factor, required by diazotrophs in order to fix atmospheric Nitrogen into a more bioavailable form such as ammonia.
...
Globally modeled dust emissions estimate total iron (TFe) mineral emissions to be \~35|Tg yr$^{-1}$, with combustion emissions of TFe of \~2|Tg yr$^{-1}$ 
